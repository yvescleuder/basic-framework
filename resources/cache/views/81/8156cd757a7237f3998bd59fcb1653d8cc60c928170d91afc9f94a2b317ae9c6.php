...
/* index.tpl.html */
class __TwigTemplate_b169daa783c12a477dc5fe263303a8fb77181665593041ff60cd6a612c1d1008 extends Twig_Template
{
...
<body>
  ...
  <section class=\"content-wrap\">
    ...
    <section class=\"youplay-news container\">
      <?php
        foreach(\$noticie->getAll() as \$key => \$value):
      ?>
          <div class=\"news-one\">
            <div class=\"row vertical-gutter\">
              ...
              <div class=\"col-md-8\">
                <div class=\"clearfix\">
                  <h3 class=\"h2 pull-left m-0\"><a href=\"blog-post-1.html\"><?php echo \$value[\"title\"]; ?></a></h3>
                  <span class=\"date pull-right\"><i class=\"fa fa-calendar\"></i> <?php echo \$value[\"time\"]; ?></span>
                </div>
                <div class=\"tags\">
                  <i class=\"fa fa-tags\"></i>  <a href=\"#\"><?php echo \$value[\"category\"]; ?></a>
                </div>
...
";
    ...
    {
        return new Twig_Source("", "index.tpl.html", "C:\\laragon\\www\\l2kael\\resources\\views\\index.tpl.html");
    }
}
